...
## Adding color as an option to function.

This is similar to using Jenny's colors. However, the idea here is to have a vector of color values without labels. The first color is for the 
